...
@implementation SVPKeyChainStore
...
+ (NSString *)getUUIDByKeyChain{
    NSString*strUUID = (NSString*)[self load:[[NSBundle mainBundle] bundleIdentifier]];
    if([strUUID isEqualToString:@""]|| !strUUID)
    {
        ...
        [self save:[[NSBundle mainBundle] bundleIdentifier] data:strUUID];
    }
    return strUUID;
}
